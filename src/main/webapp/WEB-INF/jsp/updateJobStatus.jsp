...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/static/css/updateStatus.css">
</head>
<body>
            ...
            <form action="${pageContext.request.contextPath}/staff/assignments/update-status/save" method="post">
                ...
                <div class="status-list">
                    ...
                    <label class="status-option">
                        <input type="radio" name="jobStatus" value="Assigned" ${b.bookingStatus == 'Assigned' ? 'checked' : ''}>
                        <div class="text-group">
                            <strong><span class="dot" style="background:#6c757d;"></span>มอบหมายงานแล้ว (Assigned)</strong>
                            <small>พนักงานรับทราบงานแล้ว รอเริ่มดำเนินการ</small>
                        </div>
                    </label>

                    <label class="status-option">
                        <input type="radio" name="jobStatus" value="Preparing" ${b.bookingStatus == 'Preparing' ? 'checked' : ''}>
                        <div class="text-group">
                            <strong><span class="dot" style="background:#ffc107;"></span>กำลังเตรียมงาน (Preparing)</strong>
                            <small>จัดหาอุปกรณ์และของใช้สำหรับพิธีกรรม</small>
                        </div>
                    </label>

                    <label class="status-option">
                        <input type="radio" name="jobStatus" value="In_Progress" ${b.bookingStatus == 'In_Progress' ? 'checked' : ''}>
                        <div class="text-group">
                            <strong><span class="dot" style="background:#17a2b8;"></span>กำลังดำเนินการ (In Progress)</strong>
                            <small>พนักงานกำลังปฏิบัติงานที่สถานที่จัดงาน</small>
                        </div>
                    </label>

                    <label class="status-option">
                        <input type="radio" name="jobStatus" value="Completed" ${b.bookingStatus == 'Completed' ? 'checked' : ''}>
                        <div class="text-group">
                            <strong><span class="dot" style="background:#28a745;"></span>เสร็จสิ้นงานบุญ (Completed)</strong>
                ...
                <div class="footer-btns">
                    <a href="${pageContext.request.contextPath}/organizer/bookings?status=Confirmed" class="btn btn-cancel">← ย้อนกลับ</a>
