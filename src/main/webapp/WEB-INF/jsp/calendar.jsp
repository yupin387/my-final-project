		...
		<div class="container">
			...
			<div class="cal-explain-box">
				...
				<p class="cal-explain-text">
					...
					ในการจัดงานบุญต่างๆ เช่น งานทำบุญบ้าน งานบวช งานแต่งงาน งานขึ้นบ้านใหม่
			...
			<div class="lc-calendar">
				...
				<div class="lc-explain-box">
					...
					<p class="lc-explain-text">
						...
						การแต่งงาน การบวช และงานประเพณีท้องถิ่น โดยแต่ละวันจะมีการกำกับด้วย "ชื่อวันไท"
						ตามระบบนักษัตรล้านนา ควบคู่กับแท็กบอกลักษณะของวัน เช่น วันดี วันหัวเรียงหมอน (ฤกษ์ดีสำหรับแต่งงาน)
