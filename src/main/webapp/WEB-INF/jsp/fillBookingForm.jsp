...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/static/css/bookingForm.css?v=4">
</head>
<body>
    ...
    <form action="${pageContext.request.contextPath}/saveBooking" method="post">
        ...
        <div class="form-grid">
            ...
            <div>
                ...
                <%-- รายละเอียดการจัดพิธี (เฉพาะ: จำนวนแขก + คำถามบ้านใหม่) --%>
			    <div class="form-card">
			        <div class="card-header">รายละเอียดการจัดพิธี</div>
			        <div class="card-body">
			
			            <%-- คำถาม: ต้องการชุดอุปกรณ์ที่ใช้บ้านใหม่หรือไม่ --%>
			            <c:forEach items="${questions}" var="q">
			                <c:if test="${fn:contains(q.questionsText, 'บ้านใหม่')}">
			                    <div class="form-group">
			                ...
			                <c:if test="${fn:contains(q.questionsText, 'แขก')}">
			                    <div class="form-group">
			                        ...
			                        <input type="text" name="details[${detailIndex}].answer"
			                               class="form-control" placeholder="ระบุจำนวนแขก..." required>
			                    </div>
			                    <c:set var="detailIndex" value="${detailIndex + 1}"/>
			                </c:if>
			            </c:forEach>
