...
public class Run {
	public static void main(String[] args) {
		...
		try {
			...
			ItemType t6 = new ItemType("อุปกรณ์เสริม (เลือกเพิ่มเอง)"); // ใหม่
			...
			// --- บริการ (t3) ---
			// FIX: unit เป็น "รูป" คิดตามจำนวนพระอยู่แล้ว ใส่ (ต่อรูป) ให้ตรงกับ keyword
			// ที่ quotationForm.jsp ใช้เช็คว่าอุปกรณ์/บริการนี้ต้องคูณจำนวนตามจำนวนพระหรือไม่
			items.add(new Item("บริการประสานงานนิมนต์พระ",
			...
			items.add(new Item("เก้าอี้ (โปรโมชั่นฟรี)", "เก้าอี้สะอาด สวยงาม พร้อมใช้งาน 10 ตัว  — แถมฟรีตามโปรโมชั่น",
					"ขุด", 0.0, t3, allCeremonies));
			items.add(new Item("โต๊ะพร้อมผ้าคลุม (โปรโมชั่นฟรี)", "โต๊ะจัดเต็ม เข้าชุด ดูเรียบร้อย พร้อมผ้าคลุม 2 ตัว — แถมฟรีตามโปรโมชั่น",
					"ขุด", 0.0, t3, allCeremonies));

			// --- อุปกรณ์พิธีกรรมพื้นฐาน (t1) ---
			items.add(new Item("บายศรีสู่ขวัญ", "บายศรีปากชาม สำหรับพิธีสักการะ", "ชุด", 1500.0, t1, allCeremonies));

			// FIX: อาสนะพระสงฆ์ ต้องมีครบทุกรูปที่นิมนต์มา -> คูณตามจำนวนพระ (ต่อรูป)
			items.add(new Item("อาสนะพระสงฆ์", "เบาะรองนั่งกำมะหยี่สำหรับพระสงฆ์ (ต่อรูป)", "ตัว", 250.0, t1,
					allCeremonies));
			...
			// FIX: ตาลปัตรพระถือคนละอัน -> คูณตามจำนวนพระ (ต่อรูป)
			items.add(new Item("ตาลปัตรพร้อมขาตั้ง", "ตาลปัตรสำหรับพระสงฆ์ พร้อมขาตั้ง (ต่อรูป)", "ชุด", 350.0, t1,
					allCeremonies));
			items.add(new Item("พวงมาลัยดอกไม้สดถวายพระพุทธ", "พวงมาลัยดอกไม้สดสำหรับถวายพระพุทธรูป", "พวง", 150.0,
					t1, allCeremonies));
			// FIX: กรวยดอกไม้ถวายพระเป็นรายรูป -> คูณตามจำนวนพระ (ต่อรูป)
			items.add(new Item("กรวยดอกไม้ถวายพระสงฆ์", "กรวยดอกไม้สดสำหรับถวายพระสงฆ์ (ต่อรูป)", "กรวย", 200.0, t1,
					allCeremonies));
			...
			// ========================================================
			// F. อุปกรณ์เพิ่มเติม (ของที่ลูกค้ามักขอเพิ่มในช่อง "ความต้องการเพิ่มเติม"
			// เช่น เต็นท์ โต๊ะ เก้าอี้ ฯลฯ) — ไม่ผูก auto กับคำตอบลูกค้า แต่เตรียมไว้ให้
			// ผู้จัดงานกดเลือกจากป๊อปอัพ "เลือกรายการวัสดุอุปกรณ์เสริม" ได้ทันทีหลังอ่าน
			// หมายเหตุที่ลูกค้ากรอกมา — ราคาด้านล่างเป็นราคาประมาณ ปรับได้ตามจริง
			// ========================================================
			// ========================================================
			// F. อุปกรณ์เพิ่มเติม — ต้องกดเลือกเองจากป๊อปอัพเท่านั้น ไม่รวมในแพ็กเกจ
			// ========================================================
			items.add(new Item("เต็นท์ขนาดมาตรฐาน", "เต็นท์ผ้าใบขนาดมาตรฐาน สำหรับกันแดดกันฝนบริเวณจัดงาน",
			        "หลัง", 2000.0, t6, allCeremonies));
			items.add(new Item("โต๊ะเพิ่มเติม", "โต๊ะพร้อมผ้าคลุม สำหรับกรณีต้องการเพิ่มเติมนอกเหนือจากที่รวมในแพ็กเกจ",
			        "ตัว", 150.0, t6, allCeremonies));
			items.add(new Item("เก้าอี้เพิ่มเติม", "เก้าอี้สำหรับแขกร่วมงาน กรณีต้องการเพิ่มเติมนอกเหนือจากที่รวมในแพ็กเกจ",
			        "ตัว", 30.0, t6, allCeremonies));
			items.add(new Item("พัดลมไอเย็น", "พัดลมไอเย็นสำหรับบริเวณจัดงานกลางแจ้ง", "ตัว", 500.0, t6,
			        allCeremonies));
			items.add(new Item("ไมโครโฟนไร้สายเพิ่มเติม", "ไมค์ลอยไร้สายสำหรับพิธีกรหรือผู้กล่าวสุนทรพจน์เพิ่มเติม",
			        "ตัว", 300.0, t6, allCeremonies));
			items.add(new Item("พรมทางเดิน", "พรมปูทางเดินบริเวณจัดงาน", "เส้น", 600.0, t6, allCeremonies));
