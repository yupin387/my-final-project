...
public class Run {
	public static void main(String[] args) {
		...
		try {
			...
			items.add(new Item("โต๊ะ", "โต๊ะพร้อมผ้าคลุม สำหรับกรณีต้องการเพิ่มเติม",
			        "ตัว", 150.0, t6, allCeremonies));
			items.add(new Item("เก้าอี้", "เก้าอี้สำหรับแขกร่วมงาน กรณีต้องการเพิ่มเติม",
			        "ตัว", 30.0, t6, allCeremonies));
			items.add(new Item("พัดลมไอเย็น", "พัดลมไอเย็นสำหรับบริเวณจัดงานกลางแจ้ง", "ตัว", 500.0, t6,
			        allCeremonies));
			items.add(new Item("ไมโครโฟนไร้สาย", "ไมค์ลอยไร้สายสำหรับพิธีกรหรือผู้กล่าวสุนทรพจน์เพิ่มเติม",
