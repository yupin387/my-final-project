...
public class Run {
	public static void main(String[] args) {
		...
		try {
			...
			items.add(new Item("บริการเครื่องเสียง", "ไมโครโฟนและลำโพงสำหรับประกอบพิธี", "ชุด", 1200.0, t3,
					List.of(c1, c2)));

			items.add(new Item("บริการทำความสะอาดหลังงาน", "เก็บอุปกรณ์และทำความสะอาดพื้นที่หลังเสร็จพิธี", "ครั้ง",
					1000.0, t3, List.of(c1, c2)));
